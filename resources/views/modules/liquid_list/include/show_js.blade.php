...
var dtTable2 = $('#myTable2').DataTable({
    ...
    scrollX: true,
    pageLength: 50,
    order: [ [10,'desc'],[6,'desc'],[7,'desc'] ],
    columnDefs: [
        { className: 'text-center', targets: ['_all'] },
    ],
    ajax: {
        url : '{{ route("liquid-lists.dtShow2") }}',
        data : {
            initId:'{{ $data["initId"] }}'
        },
    },
    columns: [
        ...
        { data: 'tc_inits.tc_samples.program', name: 'tc_inits.tc_samples.program', orderable:true, searchable:true},
        { data: 'tc_inits.tc_samples.sample_number_display', name: 'tc_inits.tc_samples.sample_number', orderable:true, searchable:true},
        { data: 'tc_liquid_bottles.alpha', name: 'tc_liquid_bottles.alpha', orderable:true, searchable:true},
        { data: 'tc_liquid_bottles.cycle', name: 'tc_liquid_bottles.cycle', orderable:true, searchable:true},
        { data: 'tc_liquid_bottles.tc_workers.code', name: 'tc_liquid_bottles.tc_workers.code', orderable:true, searchable:true},
        { data: 'first_total', name: 'tc_liquid_bottles.bottle_date', orderable:true, searchable:true},
        ...
        { data: 'last_total', name: 'tc_liquid_bottles.created_at', orderable:true, searchable:true},
    ],
    initComplete: function () {

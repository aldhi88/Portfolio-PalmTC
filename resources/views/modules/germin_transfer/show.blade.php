...
@section('css')
@include('modules.germin_transfer.include.show_css')
@endsection

@section('js')
@include('modules.germin_transfer.include.show_js')
@include('modules.germin_transfer.include.delete_js')
@endsection
    ...
    <div class="col">
        <div class="card border border-sm">
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <a href="{{ route('germin-transfers.index') }}" class="btn btn-warning btn-sm"><i class="fas fa-backward mr-2"></i>Transfer Summary</a>
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="row text-center">
                            ...
                            <div class="col">
                                <div class="form-group mb-0">
                                    <label><strong>Bottle Germin: </strong></label><br>{{ $data['sumGermin'] }}
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group mb-0">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col text-right">
                        ...
                        <a href="{{ route('germin-transfers.create',$data['initId']) }}" class="btn btn-sm btn-primary"><i class="fas fa-exchange-alt"></i> New Transfer</a>
                        @endif
                    </div>
                </div>
            </div>
...
@include('modules.germin_transfer.include.modal')

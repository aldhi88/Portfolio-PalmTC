...
@section('css')
@include('modules.germin_ob.include.show_css')
@endsection

@section('js')
@include('modules.germin_ob.include.show_js')
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="row text-center">
                            ...
                            <div class="col">
                                <div class="form-group mb-0">
                                    <label><strong>Total Germin: </strong><br>{{ $data['totalGermin'] }}</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col">
                ...
                <table id="myTable2" class="table table-striped table-bordered nowrap table-xs w-100">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th class="text-center bg-success text-light">Ger</th>
...
@include('modules.germin_ob.include.modal')
@endsection

...
<script>
    ...
    function initDt(obsDate = null){
        var dtTable = $('#myTable').DataTable({
            ...
            columns: [
                ...
                { data: 'form_germin', name: 'form_germin', orderable:false, searchable:false},
    ...
    function initFormObs(){
        $('body').on('change','input.form-obs',function(){
            ...
            formData.tc_germin_ob_id = '{{ $data["obsId"] }}';
            formData.tc_germin_bottle_id = $(this).attr('data-id');
            ...
            $.ajax({
                ...
                url: '{{ route("germin-obs.storeObDetail") }}',
                data: formData,
                success: function(a) {
                    $('#alert-area2').empty();

...
@section('css')
@include('modules.field_list.include.show_css')
@endsection

@section('js')
@include('modules.field_list.include.show_js')
@endsection
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        ...
                        <a href="{{ route('field-lists.index') }}" class="btn btn-warning btn-sm has-ripple"><i class="fas fa-backward mr-2"></i>Back</a>
                    </div>

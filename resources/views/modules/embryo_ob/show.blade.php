...
@section('css')
@include('modules.embryo_ob.include.show_css')
@endsection

@section('js')
@include('modules.embryo_ob.include.show_js')
@endsection
    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <a href="{{ route('embryo-obs.index') }}" class="btn btn-warning btn-sm rounded-0"><i class="fas fa-backward mr-2"></i>Back</a>
                        <a href="{{ route('embryo-transfers.show',$data['initId']) }}" class="btn btn-primary btn-sm"><i class="feather icon-share-2 mr-2"></i>Transfer</a>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="row text-center">
                            ...
                            <div class="col">
                                <div class="form-group mb-0">
                                    <label><strong>Total Embryo: </strong><br>{{ $data['totalEmbryo'] }}</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col text-right">
                        ...
                        <a href="{{ route('embryo-obs.create',$data['nextOb']) }}" class="btn btn-primary btn-sm rounded-0"><i class="feather mr-2 icon-plus"></i>New Observation</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <table id="myTable2" class="table table-striped table-bordered nowrap table-xs w-100">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th class="text-center bg-success text-light">Emb</th>
...
@include('modules.embryo_ob.include.modal')
@endsection

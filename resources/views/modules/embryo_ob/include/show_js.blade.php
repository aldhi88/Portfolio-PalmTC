...
<script>
    ...
    var dtTable = $('#myTable').DataTable({
        ...
        ajax: {
            url : '{{ route("embryo-obs.dtShow") }}',
            data : {
                initId:'{{ $data["initId"] }}'
            },
        },
        columns: [
            { data: 'work_date_format', name: 'work_date', orderable:true, searchable:false},
            ...
            { data: 'total_bottle_embryo', name: 'total_bottle_embryo', orderable:true, searchable:true},
    ...
    var dtTable2 = $('#myTable2').DataTable({
        ...
        columns: [
            ...
            { data: 'bottle_date_format', name: 'tc_embryo_bottles.bottle_date', orderable:true, searchable:true},
            { data: 'tc_embryo_bottles.sub', name: 'tc_embryo_bottles.sub', orderable:false, searchable:true},
            { data: 'tc_embryo_bottles.tc_workers.code', name: 'tc_embryo_bottles.tc_workers.code', orderable:false, searchable:true},
            { data: 'first_total', name: 'first_total', orderable:false, searchable:false},
            { data: 'work_date_format', name: 'work_date_format', orderable:false, searchable:true},
            { data: 'tc_workers.code', name: 'tc_workers.code', orderable:false, searchable:true},
            { data: 'bottle_embryo', name: 'bottle_embryo', orderable:true, searchable:false},
            ...
            { data: 'last_total', name: 'tc_embryo_bottles.bottle_date', orderable:true, searchable:false},
        ],
        initComplete: function () {
    ...
    $('#formDel').submit(function (e) {
        ...
        $.ajax({
            ...
            url: '{{ url("embryo-obs") }}/'+formData.get('id'),
            data: formData,
            success: (a) => {
                dtTable.ajax.reload();

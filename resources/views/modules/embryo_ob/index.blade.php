...
@section('css')
@include('modules.embryo_ob.include.index_css')
@endsection

@section('js')
@include('modules.embryo_ob.include.index_js')
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="row text-center">
                            ...
                            <div class="col">
                                <div class="form-group mb-0">
                                    <label><strong>Total Bottle Callus: </strong>{{ $data['totalBottle'] }}</label>
                                    <span></span>
                                </div>
                            </div>
                        </div>
                ...
                <table id="myTable" class="table table-striped table-bordered nowrap table-xs w-100">
                    <thead>
                        <tr>
                            ...
                            <th>Observation<br>Count</th>
                            <th>Total<br>Embryo</th>

...
@section('css')
@include('modules.harden_ob.include.show_css')
@endsection

@section('js')
@include('modules.harden_ob.include.show_js')
@endsection
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        ...
                        <a href="{{ route('harden-obs.index') }}" class="btn btn-warning btn-sm has-ripple"><i class="fas fa-backward mr-2"></i>Back</a>
                    </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col text-right">
                        <h5><i class="feather icon-calendar"></i> Harden Date : <span id="select-data">-</span></h5>
...
@include('modules.harden_ob.include.modal')
@endsection

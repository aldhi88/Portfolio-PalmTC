...
@section('css')
@include('modules.rooting_ob.include.create_css')
@endsection

@section('js')
@include('modules.rooting_ob.include.create_js')
@endsection
    ...
    <div class="col">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <a href="{{ route('rooting-obs.index') }}" class="btn btn-warning btn-sm"><i class="fas fa-backward mr-2"></i>All Data</a>
                        <a href="{{ route('rooting-obs.show',$data['initId']) }}" class="btn btn-warning btn-sm"><i class="fas fa-backward mr-2"></i>Detail</a>
                        <span class="ml-3">
                    ...
                    <div class="col">
                        <table id="myTable" class="table table-striped table-bordered nowrap table-xs w-100">
                            <thead>
                                ...
                                <tr>
                                    <th width="60" class="text-center">Rooting</th>
                                    <th width="60" class="text-center">Oxidate</th>
                                    <th width="60" class="text-center">Contam</th>

...
@section('css')
@include('modules.nur_list.include.show_css')
@endsection

@section('js')
@include('modules.nur_list.include.show_js')
@endsection
    ...
    <div class="col">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <h5><i class="feather icon-file-text"></i> All Data Per Date (Nursery)</h5>
                        <a href="{{ route('nur-lists.index') }}" class="btn btn-warning btn-sm has-ripple"><i class="fas fa-backward mr-2"></i>Back</a>
                    </div>
    ...
    <div class="col">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <h5><i class="feather icon-file-text"></i> All Data Per Date (Estate)</h5>
                        <a href="{{ route('nur-lists.index') }}" class="btn btn-warning btn-sm has-ripple"><i class="fas fa-backward mr-2"></i>Back</a>
                    </div>
                    <div class="col text-right">
                        <h5>Sample:</h5>

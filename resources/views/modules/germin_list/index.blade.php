...
@section('css')
@include('modules.germin_list.include.index_css')
@endsection

@section('js')
@include('modules.germin_list.include.index_js')
@endsection
                ...
                <div class="card-header-right">
                    <div class="btn-group card-option">
                        ...
                        <ul class="list-unstyled card-option dropdown-menu dropdown-menu-right">
                            ...
                            <li class="dropdown-item"><a href="{{ route('import.germinExport') }}"><span><i class="feather icon-download"></i> Download Excel Template</span></a>
                            </li>
                        </ul>
                    </div>
                </div>

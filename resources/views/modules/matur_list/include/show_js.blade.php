...
var dtTable = $('#myTable').DataTable({
    ...
    columns: [
        ...
        { data: 'bottle_count', name: 'bottle_count', orderable:true, searchable:false},
    ...
    footerCallback: function ( row, data, start, end, display ) {
        ...
        col2Total = api.column( 6, { page: 'current'} ).data().reduce( function (a, b) {
                return intVal(a) + intVal(b);
            }, 0 );
        firstTotal = api.column( 7, { page: 'current'} ).data().reduce( function (a, b) {
                return intVal(a) + intVal(b);
            }, 0 );
        lastTotal = api.column( 8, { page: 'current'} ).data().reduce( function (a, b) {
                return intVal(a) + intVal(b);
            }, 0 );
...
var dtTable2 = $('#myTable2').DataTable({
    ...
    columns: [
        ...
        { data: 'tc_inits.tc_samples.program', name: 'tc_inits.tc_samples.program', orderable:true, searchable:true},
        { data: 'tc_inits.tc_samples.sample_number_display', name: 'tc_inits.tc_samples.sample_number', orderable:true, searchable:true},
        { data: 'tc_matur_bottles.alpha', name: 'tc_matur_bottles.alpha', orderable:true, searchable:true},
        { data: 'tc_matur_bottles.tc_workers.code', name: 'tc_matur_bottles.tc_workers.code', orderable:true, searchable:true},
        { data: 'first_total', name: 'tc_matur_bottles.bottle_date', orderable:true, searchable:true},
        ...
        { data: 'last_total', name: 'tc_matur_bottles.created_at', orderable:true, searchable:true},
    ],
    initComplete: function () {

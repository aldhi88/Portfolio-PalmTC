...
@section('css')
@include('modules.matur_list.include.show_css')
@endsection

@section('js')
@include('modules.matur_list.include.show_js')
@endsection
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        ...
                        <a href="{{ route('matur-lists.index') }}" class="btn btn-warning btn-sm has-ripple"><i class="fas fa-backward mr-2"></i>Back</a>
                    </div>
...
{{-- @include('modules.matur_list.include.modal') --}}
@endsection

            ...
            <div class="card-body">
                <table id="myTable" class="table table-striped table-bordered nowrap table-xs w-100">
                    <thead>
                        ...
                        <tr>
                            {{-- Grow Callus --}}
                            <th class="text-center" width="50"><i class="fas fa-flask text-primary"></i></th>
                            <th class="text-center" width="50"><i class="fas fa-leaf text-success"></i></th>
                            {{-- Callus Percentage (%) --}}
                            <th class="text-center" width="60"><i class="fas fa-flask text-primary"></i></th>
                            <th class="text-center" width="60"><i class="fas fa-leaf text-success"></i></th>
                            {{-- Contamination --}}
                            <th class="text-center" width="50"><i class="fas fa-flask text-warning"></i></th>
                            <th class="text-center" width="50"><i class="fas fa-leaf text-warning"></i></th>
                            {{-- Oxidate --}}

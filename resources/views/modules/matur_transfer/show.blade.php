...
@section('css')
@include('modules.matur_transfer.include.show_css')
@endsection

@section('js')
@include('modules.matur_transfer.include.show_js')
@include('modules.matur_transfer.include.delete_js')
@endsection
    ...
    <div class="col">
        <div class="card border border-sm">
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <a href="{{ route('matur-transfers.index') }}" class="btn btn-warning btn-sm"><i class="fas fa-backward mr-2"></i>Transfer Summary</a>
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="row text-center">
                            ...
                            <div class="col">
                                <div class="form-group mb-0">
                                    <label><strong>Bottle Matur: </strong></label><br>{{ $data['sumMatur'] }}
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group mb-0">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col text-right">
                        ...
                        <a href="{{ route('matur-transfers.create',$data['initId']) }}" class="btn btn-sm btn-primary"><i class="fas fa-exchange-alt"></i> New Transfer</a>
                        @endif
                    </div>
                </div>
            </div>
...
@include('modules.matur_transfer.include.modal')

...
@section('css')
@include('modules.aclim_transfer.include.show_css')
@endsection

@section('js')
@include('modules.aclim_transfer.include.show_js')
@include('modules.aclim_transfer.include.delete_js')
@include('modules.aclim_transfer.include.transfer_js')
@endsection
    ...
    <div class="col">
        <div class="card border border-sm">
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <a href="{{ route('aclim-transfers.index') }}" class="btn btn-warning btn-sm"><i class="fas fa-backward mr-2"></i>Transfer Summary</a>
                    </div>
...
@include('modules.aclim_transfer.include.modal')
